...
namespace CompanyService.Consumers
{
    ...
    /// </summary>
    public class IsValidBookingTimeRequestedConsumer : IConsumer<IsValidBookingTimeRequested>
    {
        private readonly Context dbcontext;
        private readonly IBookingValidationService validationService;
        public IsValidBookingTimeRequestedConsumer(Context context, IBookingValidationService validationService)
        {
            dbcontext = context;
