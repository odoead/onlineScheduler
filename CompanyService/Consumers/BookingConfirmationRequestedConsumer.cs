...
namespace CompanyService.Consumers
{
    ...
    /// </summary>
    public class BookingConfirmationRequestedConsumer : IConsumer<BookingConfirmationRequested>
    {
        private readonly Context dbcontext;
        private readonly IBookingValidationService validationService;
        public BookingConfirmationRequestedConsumer(Context context, IBookingValidationService bookingValidationService)
        {
            dbcontext = context;
        ...
        public async Task Consume(ConsumeContext<BookingConfirmationRequested> context)
        {
            ...
            await context.RespondAsync<BookingConfirmationRequestResult>(result);
        }
