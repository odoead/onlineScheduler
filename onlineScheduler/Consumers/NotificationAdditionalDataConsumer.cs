...
{
    public class NotificationAdditionalDataConsumer : IConsumer<NotificationAdditionalDataRequested>
    {
        private readonly Context dbcontext;
        public NotificationAdditionalDataConsumer(Context context)
        {
            dbcontext = context;
        }
        public async Task Consume(ConsumeContext<NotificationAdditionalDataRequested> context)
        {
            ...
            await context.RespondAsync<NotificationAdditionalDataResult>(new NotificationAdditionalDataResult { Data = dataPairs });
        }
    }
}
